...
namespace StoryblokLens\Traits;

trait StoryblokTrait
{
    public function getRegionFromSpaceId($spaceId): string
    {
     ...
     * related to the code.
     */
    public function getPlanDescription($planLevel): string
    {
    ...
    public function baseUriFromRegionForMapi(string $region): string
    {
        return match ($region) {
    ...
    public function baseUriFromRegionForOauth(string $region): string
    {
        return match ($region) {
            "US" => "https://api-us.storyblok.com",
            "CA" => "https://api-ca.storyblok.com",
